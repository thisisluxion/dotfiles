...
Config.instname = "University of Udine"
Config.profilename = "Studenti"
Config.url = "https://servizi-informatici.uniud.it/reti/wi-fi"
Config.email = "wifi-support@uniud.it"
Config.title = "eduroam CAT"
Config.server_match = "navaga.cc.uniud.it"
...
Config.user_realm = "spes.uniud.it"
Config.ssids = ['eduroam']
Config.del_ssids = []
Config.servers = ['DNS:navaga.cc.uniud.it']
Config.use_other_tls_id = False
Config.anonymous_identity = "anonymous20220423@spes.uniud.it"
